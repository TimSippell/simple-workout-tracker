...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            Section("Weight Unit") {
                ...
                .onChange(of: weightUnit) { newValue in
                    OwtBridge.shared.setWeightUnit(newValue)
                }
            }
            ...
            Section("Data") {
                ...
                NavigationLink("Share with Nearby Device") { ShareView() }
            }
        ...
        .onAppear { weightUnit = OwtBridge.shared.getWeightUnit() }
        .alert("Reset All Data", isPresented: $showResetAlert) {
            Button("Delete Everything", role: .destructive) {
                OwtBridge.shared.close()
                let supportDir = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
                let dbPath = supportDir.appendingPathComponent("owt.db")
        ...
        .alert("Import Data", isPresented: Binding(
            ...
            Button("Import") {
                if let json = pendingImportJson {
                    importMessage = OwtBridge.shared.importFromJson(json: json)
                }
                importSummary = nil
        ...
        .fileExporter(
            ...
            document: JsonDocument(json: OwtBridge.shared.exportToJson()),
            contentType: .json,
            defaultFilename: "owt-export.json"
        ) { result in
            switch result {
        ...
        .fileImporter(
            ...
            case .success(let url):
                ...
                do {
                    ...
                    if let summary = OwtBridge.shared.previewImport(json: json) {
